$(document).ready(function () {
    ...
    function hideAllMenu() {
        ...
        $('#cd-vertical-nav').hide(200);
    }

    function showAllMenu() {
        $('#trigger-overlay').show(550);
        $('#cd-vertical-nav').show(200);
    }
    ...
    //function menuScopMobile() {
    //    $('.overlay-contentscale ul li a').click(function () {
    //        var data = $(this).attr('data-index');

    //        $('.main').each(function () {

    //            var aktywna = $(this).find('section');

    //            for (i = 0; i < aktywna.length; i++) {
    //                var zmienna = $(this).attr('data-index');
    //                console.log(zmienna);

    //                if ($(zmienna) == data) {
    //                    $(this)[i].addClass('active');
    //                    alert($(this)[i]).attr('data-index');
    //                }
    //            }
    //        });
    ...
    function enabledScroll() {
        if (jQuery.browser.mobile && $(window).width() < 760) {
